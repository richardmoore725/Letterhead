...
class EmailChannelAdministratorsJob extends Job
{
    ...
    public function handle(
        ...
        $heading = "A new promotion in {$newsletterName} has been scheduled";
        ...
        $administratorEmailsArray = array_map(
            function ($brandAdministrator) use ($queue, $newsletterName, $callToAction, $callToActionUrl, $heading) {
                ...
                $copy = "
                    ...
                    <p>
                        We are just confirming {$this->userName} placed a new promotion in {$newsletterName}
