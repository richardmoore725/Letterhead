...
class UserRepositoryTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->repository = new UserRepository($this->client, $this->httpRequest);
    }

    public function testCanCheckWhetherUserCanPerformAction_returnsResponse()
    {
        ...
        $actualResults = $this->repository->checkWhetherUserCanPerformAction('create', 'test', $this->passport, 1);
    ...
    public function testCannotGetOrCreateAndChargeUser_returnsNull()
    {
        ...
        $actualResults = $this->repository->getOrCreateAndChargeUser(
    ...
    public function testCanGetOrCreateAndChargeUser_returnsUserDto()
    {
        $applicationFeeAmount = 200;
        $connectedStripeAccountId = "";
        $description = "";
        ...
        $this->assertInstanceOf(UserDto::class, $actualResults);
    }
}
